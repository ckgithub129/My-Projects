...
date_create: moment().fromat("DD-MM-YYYY hh:mm:ss")*/}
                 ...
                 <form onSubmit={this.handleSubmit}  id="form">
                    <div className="flex-wrapper">
                        <div style={{flex: 6}}>
                         ...
                         <div style={{flex: 1}}>
                         <div>
                            &nbsp;&nbsp;&nbsp;&nbsp;<button  id="submit" className="btn btn-warning" type="submit">Add</button></div>
                    ...
                    {tasks.map(function(task, index){
                      return(
                          <div key={index} className="task-wrapper flex-wrapper">
                            ...
                            <div style={{flex:1}}>
                                 <button onClick={() => self.strikeUnstrike(task)} className="btn btn-sm btn-outline-dark delete">Done</button>
                            </div>
